    ...
    return (
        <div className="relative space-y-3 dark">
            ...
            <button type="button" onClick={()=>setIsOpen(!isOpen)}
                className="flex w-full item-center justify-between rounded-md border px-4 py-3 text-left transition bg-white/8 border-white/10 text-zinc-200 hover:bg-white/12">
